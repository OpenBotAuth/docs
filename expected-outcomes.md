...
6. **Open verification standard:** No single entity should monopolize bot authentication and blocking decisions, ensuring the system remains open and resistant to centralized control.
